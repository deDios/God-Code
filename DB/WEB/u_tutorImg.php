...
try {
  ...
  if ($tutorId <= 0) respond(false, 'Falta tutor_id');
  ...
  //  Paths 
  // Los assets se guardan en /ASSETS/tutor/
  $root = dirname(__DIR__, 2);
  $destDir = $root . DIRECTORY_SEPARATOR . 'ASSETS' . DIRECTORY_SEPARATOR . 'tutor';
  if (!is_dir($destDir)) {
  ...
  //  URL pública 
  $publicUrl = "/ASSETS/tutor/{$fileName}?v=" . time();
