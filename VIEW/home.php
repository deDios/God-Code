...
<body>
    ...
    <header>
        <div class="top-bar">
            ...
            <div class="logo"><img src="../ASSETS/godcode_icon.png" alt="Logo GodCode" class="logo-icon">GodCode</div>
            <div class="actions">
                <button class="btn btn-outline" onclick="location.href='#'">Contactanos!</button>
        ...
        <div class="subnav">
            <a href="#" class="active">Inicio</a><!-- esta activa la pagina "Inicio" -->
            <a href="#">Productos</a>
