...
<body>
    ...
    <main>
        ...
        <div class="info-grid">
            <div class="info-card">
                <h2>Maximiza los clientes potenciales y las conversiones</h2>
                <p>Consigue clientes potenciales de mayor calidad y mejora las conversiones.</p>
            </div>

            <div class="info-card">
                <h2>Aumenta las ventas en línea</h2>
                <p>Llega a los compradores donde se encuentren y aumenta el tráfico y las ventas de tu sitio.</p>
            </div>

            <div class="info-card">
                <h2>Impulsa el tráfico presencial en la tienda</h2>
                <p>Atrae a los consumidores a tu tienda y aumenta las ventas tradicionales.</p>
            </div>

            <div class="info-card">
                <h2>Muestra tu marca a más personas</h2>
                <p>Muestra tu marca para aumentar el alcance y la participación.</p>
            </div>

            <div class="info-card">
                <h2>Promociona tu aplicación para los usuarios nuevos</h2>
                <p>Promociona tu aplicación entre los usuarios adecuados para impulsar las descargas y la participación.</p>
            </div>
        </div>
    </section>
