...
<body>
  ...
  <div class="carrusel">
    <div class="slide activo">
      <div class="texto">
        <p>“Aún sigo invirtiendo en mi Perfil de Google y me ha funcionado bien en lo que cabe de esta pandemia.”</p>
        <span>Cerrautho - Medellín de Bravo, México</span>
      </div>
      <div class="imagen">
        <img src="img/testimonio1.jpg" alt="Cliente 1">
      </div>
    </div>
    ...
    <div class="slide">
      ...
      <div class="imagen">
        <img src="img/testimonio2.jpg" alt="Cliente 2">
      </div>
    </div>
    ...
    <div class="slide">
      ...
      <div class="imagen">
        <img src="img/testimonio3.jpg" alt="Cliente 3">
      </div>
    </div>
  </div>
  ...
  <div class="controles">
    <button onclick="moverCarrusel(-1)">
      <img src="img/flecha-izquierda.png" alt="Anterior">
    </button>
    <span id="indicador">1 / 3</span>
    <button onclick="moverCarrusel(1)">
      <img src="img/flecha-derecha.png" alt="Siguiente">
    </button>
  </div>
</section>
