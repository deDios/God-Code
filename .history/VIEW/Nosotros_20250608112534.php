            ...
            <div class="contenedor-carrusel">
                <div class="carrusel">
                    ...
                    <div class="slide activo">
                        ...
                        <img src="img/testimonio1.jpg" alt="Cliente 1" class="img-testimonio">
                    </div>
                    ...
                    <div class="slide">
                        ...
                        <img src="img/testimonio2.jpg" alt="Cliente 2" class="img-testimonio">
                    </div>
                    ...
                    <div class="slide">
                        ...
                        <img src="img/testimonio3.jpg" alt="Cliente 3" class="img-testimonio">
                    </div>
                </div>

                <div class="botones-carrusel">
                    <img src="img/flecha-izquierda.png" alt="Anterior" class="btn-carrusel" onclick="moverCarrusel(-1)">
                    <span id="indicador">1 / 3</span>
                    <img src="img/flecha-derecha.png" alt="Siguiente" class="btn-carrusel" onclick="moverCarrusel(1)">
                </div>
            </div>
        </section>
    </main>
