        ...
        <section class="nosotros">
            ...
            <div class="nosotros-grid">
                <div class="nosotros-card">
                    <div class="nosotros-fondo"></div>
                    <img src="../ASSETS/Nosotros/seccion1_img1.png" alt="Equipo de trabajo" />
                    <div class="nosotros-texto">
                        <h3>Acerca de nosotros.</h3>
                        <p>En GodCode, somos una startup especializada en desarrollo web que transforma ideas en
                            soluciones digitales funcionales y estéticas. Colaboramos estrechamente con nuestros
                            clientes para ayudar a emprendedores, empresas y proyectos a construir su presencia en línea
                            de forma efectiva.</p>
                    </div>
                </div>
                ...
                <div class="nosotros-card">
                    <div class="nosotros-fondo"></div>
                    <img src="../ASSETS/Nosotros/seccion1_img2.png" alt="Misión GodCode" />
                    <div class="nosotros-texto">
                ...
                <div class="nosotros-card">
                    <div class="nosotros-fondo"></div>
                    <img src="../ASSETS/Nosotros/seccion1_img3.png" alt="Historia GodCode" />
                    <div class="nosotros-texto">
                ...
                <div class="nosotros-card">
                    <div class="nosotros-fondo"></div>
                    <img src="tu-imagen-4.jpg" alt="Clientes GodCode" />
                    <div class="nosotros-texto">
                        <h3>Nuestros clientes.</h3>
                        <p>Trabajamos con diversas marcas y startups que confían en nuestra experiencia para llevar sus
                            ideas al siguiente nivel.</p>
                    </div>
                </div>
            </div>
        </section>
