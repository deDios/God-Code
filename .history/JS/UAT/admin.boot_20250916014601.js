...
(() => {
  // Garantiza que existan Admin y isAdmin antes que cualquier llamada
  window.Admin = window.Admin || {};
  if (typeof window.Admin.isAdmin !== 'function') {
    window.Admin.isAdmin = () => false; // stub, se sobreescribe después de leer la cookie
  }
})();
...
function initAdminBoot() {
  ...
  window.Admin = window.Admin || {};
  window.Admin.user = currentUser || { id: 12, name: 'uat' };
