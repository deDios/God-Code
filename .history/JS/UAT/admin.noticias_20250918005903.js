...
(() => {
  ...
  const S = {
    ...
    tempNewImages: { 1: null, 2: null }, // buffer para imágenes en modo crear
  };
    ...
    containerEl.innerHTML = `
      ...
      <div class="media-grid">
        <div class="media-card">
          <figure class="media-thumb"><img alt="Imagen 1" src="${esc(p1)}"></figure>
          <div class="media-meta"><div class="media-label">Imagen 1</div></div>
        </div>
        <div class="media-card">
          <figure class="media-thumb"><img alt="Imagen 2" src="${esc(p2)}"></figure>
